...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		{
			var item:FlxSprite = createMenuItem(option, 0, (num * 240) + 190);
		...
		var psychVer:FlxText = new FlxText(12, FlxG.height - 44, 0, "Just Engine v0.2 " + "(PE " + psychEngineVersion + ")", 12);
	...
	{
		var menuItem:FlxSprite = new FlxSprite(y, x);
	...
	override function update(elapsed:Float)
	{
		...
		if (!selectedSomethin)
		{
			...
			{
				case CENTER:
					if(controls.UI_UP_P && leftOption != null)
					{
						curColumn = LEFT;
						changeItem();
					}
